      ...
      <div className="relative z-10 p-8 space-y-8">
        ...
        <div className={cn(
          ...
          <div className="space-y-2">
            <h1 className="text-5xl font-bold text-foreground tracking-tight">Analysis Library</h1>
            <p className="text-xl text-muted-foreground">Browse and manage your recorded conversations</p>
          </div>
        ...
        <div className={cn(
          ...
          {[
            { label: 'Total Sessions', value: sessions.length.toString(), icon: LibraryIcon, color: 'from-blue-500 to-cyan-500' },
            { label: 'This Week', value: '5', icon: CalendarIcon, color: 'from-purple-500 to-pink-500' },
            { label: 'Total Hours', value: '12.5', icon: ClockIcon, color: 'from-orange-500 to-red-500' },
            { label: 'Favorites', value: sessions.filter(s => s.isFavorite).length.toString(), icon: StarIcon, color: 'from-green-500 to-emerald-500' },
          ].map((stat, index) => (
            <Card
              key={stat.label}
          ...
          {sessions.map((session, index) => (
            ...
            >
              ...
              <div className="relative h-40 overflow-hidden">
                ...
                >
                  <svg
                    className={cn('w-4 h-4', session.isFavorite ? 'fill-white' : 'fill-none')}
                    viewBox="0 0 24 24"
                    stroke="white"
                    strokeWidth="2"
                  >
        ...
        {sessions.length === 0 && (
          <Card className="p-12 text-center">
            ...
            <p className="text-muted-foreground mb-6">Try adjusting your filters or start a new recording</p>
