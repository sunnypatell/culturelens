...
export function DashboardHome({ onNavigate }: DashboardHomeProps) {
  ...
  const stats = [
    ...
    { label: 'Avg. Session Length', value: '21m', change: '-5%', trend: 'down' },
  ]
  ...
  const quickActions = [
    ...
    },
    {
      ...
      gradient: 'from-purple-500 to-pink-500',
      hoverEffect: 'hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/20'
    },
    {
      icon: ChartIcon,
      label: 'View Insights',
      ...
      gradient: 'from-orange-500 to-red-500',
      hoverEffect: 'hover:scale-105 hover:shadow-2xl hover:shadow-orange-500/20'
    },
  ]
      ...
      <div className="relative z-10 p-8 space-y-8">
        ...
        <div className={cn(
          ...
          <div className="space-y-4">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl leading-relaxed">
              Your conversation analytics dashboard. Track patterns, gain insights, and improve communication with cultural awareness.
            </p>
          </div>
        </div>
              ...
              >
                ...
                <div className="relative z-10 space-y-4">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-2xl font-bold text-white">{action.label}</h3>
        ...
        <div className={cn(
          ...
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-3xl font-bold text-foreground">Recent Sessions</h2>
              <p className="text-muted-foreground mt-1">Your latest conversation recordings</p>
            </div>
