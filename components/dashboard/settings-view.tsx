  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-primary/5 to-accent/5 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-60 right-60 w-96 h-96 bg-accent/10 rounded-full blur-3xl animate-float" style={{ animationDelay: '3s' }} />
      </div>
      ...
      <div className="relative z-10 p-8 space-y-8 max-w-6xl mx-auto">
        ...
        <Card className={cn(
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Update your personal details and profile</p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input id="organization" placeholder="Ontario Tech University" defaultValue="Ontario Tech University" className="h-11" />
            </div>
        ...
        <Card className={cn(
          ...
          <div className="space-y-6">
            <div>
              <h2 className="text-2xl font-bold text-foreground mb-2">Recording Preferences</h2>
              <p className="text-sm text-muted-foreground">Configure your default recording settings</p>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between p-4 rounded-lg bg-secondary/50 hover:bg-secondary/70 transition-colors">
                <div className="space-y-1">
                  <Label htmlFor="auto-save" className="text-base font-medium cursor-pointer">Auto-Save Recordings</Label>
              ...
              <div className="flex items-center justify-between p-4 rounded-lg bg-secondary/50 hover:bg-secondary/70 transition-colors">
                <div className="space-y-1">
                  <Label htmlFor="notifications" className="text-base font-medium cursor-pointer">Enable Notifications</Label>
              ...
              <div className="space-y-4">
                <div>
                  <Label className="text-base font-medium">Default Audio Quality</Label>
                  <p className="text-sm text-muted-foreground mb-3">Higher quality means larger file sizes</p>
                </div>
                <RadioGroup defaultValue="high">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {[
                      { value: 'standard', label: 'Standard', desc: '128 kbps • Smaller files' },
                      { value: 'high', label: 'High', desc: '256 kbps • Recommended' },
                      { value: 'maximum', label: 'Maximum', desc: '320 kbps • Best quality' },
                    ].map((option) => (
                      <label
                        key={option.value}
                        className={cn(
        ...
        <Card className={cn(
          'p-8',
          mounted && 'animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300'
        )}>
          <div className="space-y-6">
            <div>
              <h2 className="text-2xl font-bold text-foreground mb-2">Analysis Configuration</h2>
              <p className="text-sm text-muted-foreground">Customize how CultureLens analyzes your conversations</p>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between p-4 rounded-lg bg-secondary/50 hover:bg-secondary/70 transition-colors">
                <div className="space-y-1">
                  <Label htmlFor="cultural-analysis" className="text-base font-medium cursor-pointer">
                    Enable Cultural Context Analysis
                  </Label>
                  <p className="text-sm text-muted-foreground">Analyze communication through cultural awareness lens</p>
                </div>
                <Switch id="cultural-analysis" checked={culturalAnalysis} onCheckedChange={setCulturalAnalysis} />
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">Adjust how much cultural context influences insights</p>
                  </div>
                  <Badge className="text-base px-4 py-1.5">{sensitivityLevel[0]}%</Badge>
                </div>
                <Slider
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mb-3">Select what aspects to prioritize in analysis</p>
                </div>
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                  {[
                    ...
                    <Button key={focus} variant="outline" className="justify-start h-auto py-3 bg-transparent">
        ...
        <Card className={cn(
          ...
          mounted && 'animate-in fade-in slide-in-from-bottom-8 duration-700 delay-400'
        )}>
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h2 className="text-2xl font-bold text-foreground mb-2">Privacy & Data Management</h2>
            ...
            <div className="space-y-6">
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mb-3">How long to keep recordings and insights</p>
                </div>
                <RadioGroup value={dataRetention} onValueChange={setDataRetention}>
                  <div className="space-y-3">
                    {[
                      { value: '30', label: '30 Days', desc: 'Automatically delete after 1 month' },
                      { value: '90', label: '90 Days', desc: 'Automatically delete after 3 months (Recommended)' },
                      { value: '365', label: '1 Year', desc: 'Automatically delete after 1 year' },
                      { value: 'manual', label: 'Manual Only', desc: 'Keep until manually deleted' },
                    ].map((option) => (
                      <label
                        key={option.value}
        ...
        <Card className={cn(
          'p-8',
          mounted && 'animate-in fade-in slide-in-from-bottom-8 duration-700 delay-500'
        )}>
          <div className="space-y-6">
            <div>
              <h2 className="text-2xl font-bold text-foreground mb-2">Appearance</h2>
              <p className="text-sm text-muted-foreground">Customize how CultureLens looks</p>
            </div>
