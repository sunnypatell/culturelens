  ...
  const communicationPatterns = [
    {
      ...
      confidence: 'high',
      description: 'Participant A dominated 68% of speaking time, while Participant B contributed 32%.',
    ...
    },
    {
      ...
      confidence: 'high',
      description: 'High frequency of open-ended questions promoting collaborative discussion.',
    ...
    },
    {
      ...
      confidence: 'medium',
      description: 'Moderate interruption rate detected, primarily collaborative overlaps.',
    ...
    },
    {
      ...
      confidence: 'high',
      description: 'Speaking pace averaged 145 words per minute with natural pauses.',
  ...
  const culturalContext = [
    {
      ...
      description: 'Conversation shows preference for explicit, straightforward communication',
      examples: [
        '"I need to be clear about this..."',
        '"Let me state this directly..."',
        '"To put it simply..."'
      ],
      context: 'Direct communication styles value clarity and explicit messaging. This is common in low-context cultures.',
    ...
    },
    {
      ...
      context: 'Consensus-building approach where all voices are valued before decisions are made.',
      color: 'from-teal-500 to-green-500'
    },
    {
      id: 3,
      title: 'Professional Formality',
      description: 'Balanced tone mixing professional respect with personal warmth',
      examples: [
      ...
      context: 'Demonstrates flexibility in communication formality based on relationship and context.',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-primary/5 to-accent/5 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-40 right-20 w-96 h-96 bg-accent/10 rounded-full blur-3xl animate-float" style={{ animationDelay: '3s' }} />
      </div>
        ...
        <div className={cn(
          ...
          <div className="flex items-start justify-between">
            <div className="space-y-2">
              <h1 className="text-4xl md:text-5xl font-bold text-foreground">Team Strategy Meeting</h1>
              <p className="text-lg text-muted-foreground">Recorded 2 hours ago • 24:31 duration</p>
            </div>
        ...
        <Tabs defaultValue="patterns" className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-6">
              {communicationPatterns.map((pattern, index) => (
                <Card
                  ...
                  onClick={() => setExpandedInsight(expandedInsight === pattern.id ? null : pattern.id)}
                >
                  {/* Gradient accent bar */}
                  <div className={cn('h-1.5 bg-gradient-to-r', pattern.color)} />
                  ...
                  <div className="p-6 space-y-4">
                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div className="space-y-1 flex-1">
                        <div className="flex items-center gap-3">
                          <h3 className="text-2xl font-bold text-foreground">{pattern.title}</h3>
            ...
            <Card className={cn(
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 space-y-2">
                  <h3 className="font-semibold text-lg text-foreground">Cultural Context Analysis</h3>
                  <p className="text-muted-foreground leading-relaxed">
                    These observations are based on communication patterns detected in your conversation. 
                    Cultural context is complex and individual—use these insights as one perspective to consider, 
                    not definitive judgments.
                  </p>
                </div>
              </div>
            </Card>
            ...
            <div className="grid grid-cols-1 gap-6">
              {culturalContext.map((context, index) => (
                <Card
                  ...
                  style={{ animationDelay: `${index * 100}ms` }}
                >
                  <div className={cn('h-1.5 bg-gradient-to-r', context.color)} />
                  
                  <div className="p-6 space-y-4">
                    <div>
                      <h3 className="text-2xl font-bold text-foreground mb-2">{context.title}</h3>
                      <p className="text-lg text-muted-foreground">{context.description}</p>
                    </div>
              ...
              <div className="space-y-6">
                {keyMoments.map((moment, index) => (
                  <div
                    ...
                    className={cn(
                      'relative pl-24',
                      mounted && 'animate-in fade-in slide-in-from-left-8 duration-500'
                    )}
                    style={{ animationDelay: `${index * 100}ms` }}
                  >
                    {/* Timestamp badge */}
                    ...
                    <Card className="hover-lift">
                      <div className="p-6 space-y-3">
                        ...
                        <div className="flex items-center gap-2 text-sm">
                          ...
                          <span className="text-muted-foreground">{moment.participants.join(', ')}</span>
                        </div>
                      </div>
                    </Card>
                  </div>
          ...
          <TabsContent value="trends" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                { label: 'Total Sessions', value: '24', change: '+12%', icon: MicIcon },
                { label: 'Total Insights', value: '142', change: '+18%', icon: ChartIcon },
                { label: 'Avg Duration', value: '21m', change: '-5%', icon: ClockIcon },
              ].map((stat, index) => (
                <Card
                  key={stat.label}
                  className={cn(
            ...
            <Card className={cn(
              'p-8',
              mounted && 'animate-in fade-in slide-in-from-bottom-4 duration-500 delay-300'
            )}>
              <h3 className="text-2xl font-bold text-foreground mb-8">30-Day Trend</h3>
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm font-bold text-foreground">24 this month</span>
                  </div>
                      ...
                      <div key={month.month} className="flex-1 flex flex-col items-center gap-2 group">
                        <div className="w-full relative">
                          <div
                            ...
                            style={{ height: `${(month.sessions / 24) * 100}%`, minHeight: '8px' }}
                          />
                        </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm font-bold text-foreground">142 this month</span>
                  </div>
                  <div className="flex items-end justify-between gap-2 h-32">
                    {trends.map((month, i) => (
                      <div key={month.month} className="flex-1 flex flex-col items-center gap-2 group">
                        <div className="w-full relative">
                          <div
                            ...
                            style={{ height: `${(month.insights / 142) * 100}%`, minHeight: '8px' }}
                          />
                        </div>
                        <span className="text-xs text-muted-foreground font-medium">{month.month}</span>
                        <span className="text-xs font-bold text-foreground opacity-0 group-hover:opacity-100 transition-opacity">
