...
| doc                                                          | description                                    |
| ------------------------------------------------------------ | ---------------------------------------------- |
| [ELEVENLABS_SETUP.md](ELEVENLABS_SETUP.md)                   | ElevenLabs voice agent setup and configuration |
| [VOICE_SETUP_QUICKSTART.md](VOICE_SETUP_QUICKSTART.md)       | quick start guide for voice integration        |
| [VOICE_SELECTION.md](VOICE_SELECTION.md)                     | voice model selection guide                    |
