---
title: "API Reference"
description: "complete documentation for all 23 Next.js API endpoints — sessions, analysis, audio, voice, user management, auth, settings, transcripts, and health"
---

comprehensive documentation for all Next.js API routes.

> **💡 interactive explorer**: visit [`/docs/api`](/docs/api) for a full interactive API reference powered by [Scalar](https://scalar.com) with try-it-out functionality, code samples, and OpenAPI 3.1 spec.
